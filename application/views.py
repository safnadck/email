...
from .forms import FranchiseForm, BatchForm, FranchiseUserRegistrationForm, BatchFeeManagementForm, StudentFeeManagementForm, InstallmentForm, EditInstallmentForm, PaymentForm, StudentEditForm,StudentDiscountForm, EmailTemplateForm, SpecialAccessUserRegistrationForm, RoleForm, EditSpecialAccessUserForm
from .models import Franchise, UserFranchise, Batch, BatchFeeManagement, StudentFeeManagement, Installment, InstallmentTemplate, CourseFee, SpecialAccessUser, Payment, EmailTemplate
...
def email_template_list(request):
    ...
    return render(request, 'application/email_template_list.html', {'templates': templates})
...
def edit_email_template(request, template_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('application:email_template_list')
    else:
        form = EmailTemplateForm(instance=template)

    return render(request, 'application/edit_email_template.html', {'form': form, 'template': template})
