...
from .models import Franchise, UserFranchise, Batch, BatchFeeManagement, StudentFeeManagement, Installment, Payment, InstallmentTemplate, CourseFee, EmailTemplate
    ...
    class Meta:
        ...
        widgets = {
            ...
            'body': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 10,
                'placeholder': 'Write email body here (use {name}, {course_name}, {amount_paid}, etc.)'
            }),
        }
